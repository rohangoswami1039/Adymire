...
export const config = {
    ...
    port: parseInt(process.env.SERVICE_PORT || '4002', 10),
    mongoUri: process.env.MONGO_URI_IDENTITY_SERVICE  || 'mongodb://localhost:27017/identity-service',
    encryptionKey: process.env.ENCRYPTION_KEY || 'default-secret-key', // Example

};
console.log('IDENTITY PORT:', process.env.IDENTITY_SERVICE_PORT);
